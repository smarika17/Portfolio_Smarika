    ...
    return (
        <>
            <div style={{ display: "flex", flexDirection: "column" }}>
                ...
                >
                    <a style={{ display: 'flex', justifyContent: "center", alignItems: "center" }} href="https://secretkeeper-gs4v.onrender.com/"><LinkIcon style={{ color: "20a4b6", fontSize: "2rem", marginRight: "1rem" }} /><u>Deployment Link</u></a>
                </Box>
                ...
                >
                    <Box
                        ...
                        <img
                            ...
                            src="./SecretC.png" alt="YouTube Bookmark 1" />
                        <img
                            width={"50%"}
                            style={{ borderRadius: "12px", border: "1px solid rgb(26, 26, 26)" }}
                            src="./secretC2.png" alt="YouTube Bookmark 2" />
                    </Box>
                </Box>

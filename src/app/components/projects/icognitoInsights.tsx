            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
                ...
                <Accordion style={{ background: "rgba(26,26,26)", color: "white", borderRadius: "20px" }} expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                    ...
                    <AccordionDetails style={{ background: "rgba(20, 20, 20)", color: "white", borderRadius: " 0px 0px 20px 20px", fontSize: "1rem" }}>
                        ...
                        Implemented a seamless anonymous feedback system, allowing users to send reviews securely while maintaining privacy. Built a robust authentication workflow, including email signup with OTP verification, password recovery, and account deletion, to safeguard user accounts
                        </Typography>
                        <Typography textAlign={{ xs: "start", sm: "justify", md: "justify" }} >
                        Developed a validation framework using Zod to ensure accurate and secure handling of input fields
                        </Typography>
                    </AccordionDetails>
                </Accordion>
                ...
                <video width="100%" height="auto" controls style={{ marginBottom: "-0.5rem" }}>
                    <source src="./EchonAnonDemo.mov" type="video/mp4" />
                </video>
                ...
                >
                    <a style={{ display: 'flex', justifyContent: "center", alignItems: "center" }} href="https://github.com/smarika17/EchoesAnon"><LinkIcon style={{ color: "20a4b6", fontSize: "2rem", marginRight: "1rem" }} /><u>Code Link</u></a>
                </Box>

    ...
    return (
        <>
            <div style={{ display: "flex", flexDirection: "column" }}>
                ...
                >
                    <a style={{display: 'flex', justifyContent: "center", alignItems: "center" }} href="https://github.com/smarika17/BillGenerator"><LinkIcon style={{ color: "20a4b6", fontSize: "2rem", marginRight: "1rem" }} /><u>Code Link</u></a>
                </Box>

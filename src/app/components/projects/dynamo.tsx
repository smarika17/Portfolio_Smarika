            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
                ...
                <Accordion style={{ background: "rgba(26,26,26)", color: "white", borderRadius: "20px" }} expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                    ...
                    <AccordionDetails style={{ background: "rgba(20, 20, 20)", color: "white", borderRadius: " 0px 0px 20px 20px", fontSize: "1rem" }}>
                        ...
                        Create, Read, Update, and Delete operations for employee data using Spring Boot.
                        </Typography>
                        <Typography textAlign={{ xs: "start", sm: "justify", md: "justify" }} >
                        Utilizes AWS DynamoDB as the database to store and manage employee records. Provides a REST API interface
for easy interaction with the employee data.
                        </Typography>
                    </AccordionDetails>
                </Accordion>
                ...
                >
                    <a style={{ display: 'flex', justifyContent: "center", alignItems: "center" }} href="https://github.com/smarika17/Spring-Dynamo-Employee-API"><LinkIcon style={{ color: "20a4b6", fontSize: "2rem", marginRight: "1rem" }} /><u>Code Link</u></a>
                </Box>
                ...
                <div className='technology'>
                    ...
                    <div className="tech-details">
                        <img src="/postmanAPI.png" alt="java-scrip" />
                        <h1>Postman API</h1>
                    </div>
